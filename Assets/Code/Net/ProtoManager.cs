...
public class ProtoManager
{
	...
	public void AddRespDelegate(int protocol,responseDelegate d){
		...
		dels.Add(d);
		NetTools.Log("protocol : " + protocol + "   ///   dels : " + dels.Count);
	...
	public Resp TryDeserialize(byte[] buffer)
	{
		...
		NetTools.Log("protocol : " + protocol);
		Resp ret = null;
		if (mProtocolMapping.ContainsKey(protocol))
		{
			...
			NetTools.Log("no register protocol : " + protocol +"!please reg to RegisterResp.");
		}
